...
class UserTest < ActiveSupport::TestCase
   ...
   test "email validation should accept valid addresses" do
     valid_addresses = %w[user@exsample.com USER@foo.COM A_US_ER@foo.bar.org
    ...
    test "email validation should reject valid addresses" do
      invalid_addresses = %w[user@exsample,com user_at_foo.org user.name@example.
     ...
     test "emmail addresses should be saved as lower-case" do
